...
// olapDDLs contains MySQL DDL translated from ClickHouse migrations
var olapDDLs = []string{
	// Traces (from ReplacingMergeTree)
	...
	// Scores (from ReplacingMergeTree)
	...
	// DatasetRunItems (OLAP version - for ClickHouse data)
	...
	// Aggregation table: traces_all_amt
	...
	// Aggregation table: traces_7d_amt
	...
	// Aggregation table: traces_30d_amt
