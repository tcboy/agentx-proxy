...
// pgCatalogDDLs creates MySQL tables that emulate PostgreSQL system catalogs
var pgCatalogDDLs = []string{
	// pg_type emulation
	...
	// pg_proc emulation (functions Langfuse might call)
	...
	// pg_enum (for PG enum type emulation)
